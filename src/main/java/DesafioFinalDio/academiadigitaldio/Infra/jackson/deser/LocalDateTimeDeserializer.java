package DesafioFinalDio.academiadigitaldio.Infra.jackson.deser;
...
public class LocalDateTimeDeserializer extends StdDeserializer<LocalDateTime> {
    ...
    @Override
    public LocalDateTime deserialize(final JsonParser parser, final DeserializationContext context) throws IOException, IOException {
